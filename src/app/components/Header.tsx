...
const desktopLinkClass = "flex items-center gap-1.5 rounded-md px-3 py-1.5 text-sm text-zinc-500 transition-colors hover:bg-zinc-100 dark:hover:bg-zinc-800"
      ...
      <header className="border-b border-zinc-200 bg-white px-6 py-4 dark:border-zinc-800 dark:bg-zinc-950">
        <div className="mx-auto flex max-w-3xl items-center justify-between">
          ...
          <div className="hidden items-center gap-1 sm:flex">
            <Link href="/tags" className={desktopLinkClass}>{icons.tags} {t.tags}</Link>
            <Link href="/calendar" className={desktopLinkClass}>{icons.calendar} {t.calendar}</Link>
            <Link href="/history" className={desktopLinkClass}>{icons.history} {t.history}</Link>
            {user && (
              <>
                <Link href="/settings" className={desktopLinkClass}>{icons.settings}</Link>
                <button onClick={signOut} className="ml-1 flex items-center gap-1.5 rounded-md border border-zinc-200 px-3 py-1.5 text-xs text-zinc-500 transition-colors hover:bg-zinc-100 dark:border-zinc-700 dark:hover:bg-zinc-800">
